...
| Claude → Codex | Implement a feature | GPT-5.5 (medium effort) |
...
```
Routes to Claude Fable 5, Pantheon's architecture/second-opinion tier — Claude reasons through it read-only and hands the analysis back.
